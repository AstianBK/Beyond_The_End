...
public class FallenFireballRenderer extends EntityRenderer<FallenDragonFireball> {
    ...
    public FallenFireballRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }

    protected int getBlockLightLevel(FallenDragonFireball p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(FallenDragonFireball p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
    ...
    public ResourceLocation getTextureLocation(FallenDragonFireball p_114078_) {
