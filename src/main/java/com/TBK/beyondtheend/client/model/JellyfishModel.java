package com.TBK.beyondtheend.client.model;// Made with Blockbench 4.12.2
// Exported for Minecraft version 1.17 or later with Mojang mappings
// Paste this class into your mod and generate all required imports


import com.TBK.beyondtheend.BeyondTheEnd;
import com.TBK.beyondtheend.client.animacion.JellyfishAnim;
...
public class JellyfishModel<T extends JellyfishEntity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BeyondTheEnd.MODID, "jellyfish"), "main");
